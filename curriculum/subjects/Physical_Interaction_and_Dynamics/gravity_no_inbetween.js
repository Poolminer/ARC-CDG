class GravityNoInbetweenLesson extends CurriculumLesson {
    constructor() {
        super('Gravity No In-between', 'Gravity lesson without in-between frames');

        this.gravity_lesson = new GravityLesson();
    }
    generate_task(demo = false) {
        ...
        for (let i = 0; i < target_num_videos; i++) {
            let video = this.gravity_lesson.generate_task(i === 0 ? demo : false);
